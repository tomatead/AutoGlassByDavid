...
<?php
	...
	$cuerpo='Nueva mensaje de '.$_POST['nombre'].' con los siguientes datos:';
	$cuerpo.=
...
'<br>';
	...
	if(mail($destinatario, $asunto, $cuerpo,$cabeceras)){
		echo utf8_encode('<br><br><span class="msn-form">Su mensaje fue enviardo</span><br>');	 
		echo utf8_encode('<script type="text/javascript">  function redireccionarPagina() {  window.location = "index.php";  } setTimeout("redireccionarPagina()", 3500); </script>');
	 	...
	 	echo utf8_encode('<br><br><span class="msn-form">Error al enviar mensaje</span><br><p>Intente de nuevo más tarde.</p>');
		echo utf8_encode('<script type="text/javascript">  function redireccionarPagina() {  window.location = "index.php";  } setTimeout("redireccionarPagina()", 3500); </script>');	
	 } 
?>
