...
'<br>';
	...
	if(mail($destinatario, $asunto, $cuerpo,$cabeceras)){
		echo utf8_encode('<br><br><span class="msn-form">Your estimate request was sent. </span><br>');	 
		echo utf8_encode('<script type="text/javascript">  function redireccionarPagina() {  window.location = "index.php";  } setTimeout("redireccionarPagina()", 3500); </script>');
	 	...
	 	echo utf8_encode('<br><br><span class="msn-form">Error requesting estimate</span><br><p>Try again later.</p>');
		echo utf8_encode('<script type="text/javascript">  function redireccionarPagina() {  window.location = "index.php";  } setTimeout("redireccionarPagina()", 3500); </script>');	
	 } 
?>
